...
- Use TypeScript with strict settings (`strict: true`).
- Components: split into presentational components + hooks for side effects and API calls.
- State: prefer server-side or well-scoped client state (React Query, SWR, or Redux if necessary).
